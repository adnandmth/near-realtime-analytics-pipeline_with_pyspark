...
def simulate_journey(producer, device_id):
    while True:
        ...
        produce_event_to_kinesis(producer, VEHICLE_TOPIC, vehicle_data)
        produce_event_to_kinesis(producer, GPS_TOPIC, gps_data)
        produce_event_to_kinesis(producer, TRAFFIC_TOPIC, traffic_camera_data)
        produce_event_to_kinesis(producer, WEATHER_TOPIC, weather_data)
        produce_event_to_kinesis(producer, EMERGENCY_TOPIC, emergency_incident_data)
...
# Reading from the CSV file and sending data to Kinesis
with open('accounts.csv', mode='r') as csv_file:
    ...
    for row in csv_reader:
        ...
        partition_key = row['SF ID Account']
        # Produce event to Kinesis
        produce_event_to_kinesis(event_data, partition_key)
